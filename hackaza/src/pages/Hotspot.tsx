            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              >
                <div className="flex justify-center mb-6">
                  <motion.div 
                    ...
                    className="bg-gradient-to-br from-red-500 to-red-600 p-4 rounded-2xl shadow-lg"
                  >
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  AI-powered traffic analysis to identify congestion patterns and optimize urban mobility
                </p>
              </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-16">
                ...
                <motion.div
                  ...
                  className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300"
                >
                  <Navigation className="h-10 w-10 text-green-500 mb-4" />
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-semibold text-gray-700">Traffic Analytics Dashboard</span>
                      </div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <motion.button
                      ...
                      <motion.a
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        href="https://baiganinn-geoanalytics.hf.space"
                        target="_blank"
                ...
                <div className="relative bg-gray-50">
                    ...
                    {isLoading && (
                      ...
                      >
                        <div className="text-center">
                          ...
                          >
                            Preparing your traffic insights...
                          </motion.p>
                        </div>
                      </motion.div>
                    )}
                  ...
                  <iframe
                    src="https://baiganinn-geoanalytics.hf.space"
                    title="Traffic Hotspot Analytics"
                    width="100%"
                    height="800px"
                    style={{ border: 'none' }}
        ...
        {isFullscreen && (
          ...
          >
            ...
            <div className="bg-gray-900 border-b border-gray-700 px-6 py-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-semibold text-white">Traffic Analytics - Fullscreen</span>
                </div>
                <div className="flex items-center space-x-3">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
            ...
            <div className="relative h-[calc(100vh-60px)]">
              ...
              <iframe
                src="https://baiganinn-geoanalytics.hf.space"
                title="Traffic Hotspot Analytics - Fullscreen"
                width="100%"
                height="100%"
                style={{ border: 'none' }}
                onLoad={() => setIsLoading(false)}
