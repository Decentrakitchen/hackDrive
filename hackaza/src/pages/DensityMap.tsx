...
import { BarChart3, Map, Users, ExternalLink, Maximize2, Minimize2, RefreshCw, Brain } from 'lucide-react';
            ...
            <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-xl p-4 shadow-xl max-w-sm">
              <div className="flex items-start space-x-3">
                <motion.div
                  ...
                  className="flex-shrink-0 w-8 h-8 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center"
                >
                  <Brain className="w-4 h-4 text-white" />
                </motion.div>
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-800 text-sm mb-1">
                    AI Density Analysis Loading
                  </h4>
                  <p className="text-gray-600 text-xs leading-relaxed">
                    AI is processing population density patterns. This may take a few moments to complete.
                  </p>
                </div>
                <button
